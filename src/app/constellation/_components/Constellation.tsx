        ...
        >
          <div
            ...
            style={{
              ...
              backgroundColor: selectConstellation ? 'transparent' : '#d3d3d3',
              backgroundSize: selectConstellation ? '120% 120%' : 'contain',
              backgroundPosition: 'center',
              textAlign: 'center'
            }}
          >
            <div className="text-white font-bold flex flex-col justify-center items-center h-full">
              {selectConstellation ? (
                <>
                  <h2 className="text-xl font-bold mb-4">{selectConstellation.name}</h2>
                  <p className="text-lg">{selectConstellation.description}</p>
                </>
              ) : (
                <p className="text-lg text-black">별자리를 선택해주세요</p>
              )}
            </div>
          </div>
