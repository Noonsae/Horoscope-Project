...
import { DailyList as DailyListType } from '@/types/supabase/stella-result-type';
import { fetchDailyResults } from '@/utils/shareResult';
...
const DailyList = () => {
  const {
    ...
    isError,
    isPending
  } = useQuery<DailyListType[], Error, DailyListType[], [string]>({
